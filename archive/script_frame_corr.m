function [mov,f1]=script_frame_corr(filename,frames,ROI,ref_ROI,varargin)
% Author: Joshua Yeh
...
% channel_number: the channel used for the RGB analysis (R=1, G=2, B=3)
...
for fn=double(frames)
    ...
    switch channel_number
        case 1%red channel
             channel=R_channel;%scale onto grayscale (0 to 255)
        case 2%green channel
             channel=G_channel;%scale onto grayscale (0 to 255)
        case 3%blue channel
    ...
    switch channel_number
        case 1%red channel
            channel4=rm_upper_bins(channel3,thresh,0);
        case 2%green channel
            channel4=rm_upper_bins(channel3,thresh,0);
        case 3%blue channel
...
%     channel5=(channel4-thresh)+1/3;
    ...
    contour(f1.s2,channel5,5,'fill','on')
    axis(f1.s2,'image');
